...
RUN curl -sLO https://github.com/sgerrand/alpine-pkg-glibc/releases/download/${{ env.GLIBC_VER }}/glibc-${{ env.GLIBC_VER }}.apk 
RUN curl -sLO https://github.com/sgerrand/alpine-pkg-glibc/releases/download/${{ env.GLIBC_VER }}/glibc-bin-${{ env.GLIBC_VER }}.apk 
RUN apk add --no-cache glibc-${{ env.GLIBC_VER }}.apk glibc-bin-${{ env.GLIBC_VER }}.apk
...
RUN rm glibc-${{ env.GLIBC_VER }}.apk 
RUN rm glibc-bin-${{ env.GLIBC_VER }}.apk 
